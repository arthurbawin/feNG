...
std::vector<double> feSpaceTetP1::dLdr(double *r) { return {-1., 1., 0., 0.}; }
std::vector<double> feSpaceTetP1::dLds(double *r) { return {-1., 0., 1., 0.}; }
std::vector<double> feSpaceTetP1::dLdt(double *r) { return {-1., 0., 0., 1.}; }
std::vector<double> feSpaceTetP1::d2Ldr2(double *r) { return {0., 0., 0., 0.}; }
std::vector<double> feSpaceTetP1::d2Ldrs(double *r) { return {0., 0., 0., 0.}; }
std::vector<double> feSpaceTetP1::d2Lds2(double *r) { return {0., 0., 0., 0.}; }
