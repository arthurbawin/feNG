...
double dtttAnalytical(double *x, double C, double S, feRecovery *rec,
                      int direction);
...
void gradationMetriques(double gradation, int nmax, std::vector<double> &coord, std::map<int, SMetric3> &metricsOnGmshModel);
...
int computePointsUsingScaledCrossFieldPlanarP2(
  ...
  void interpolateMetricAndDerivativeOnP2EdgeWrapper(void*, const double,
  const Eigen::Matrix2d&, const Eigen::Matrix2d&, const Eigen::Matrix2d&,
  const Eigen::Matrix2d&, const Eigen::Matrix2d&,
  Eigen::Matrix2d&, Eigen::Matrix2d&, Eigen::Matrix2d&),

  void interpolateMetricP1Wrapper1D(void*, const double *, const double *, 
  Eigen::Matrix2d&, Eigen::Matrix2d&),

  void interpolateMetricAndDerivativeOnP2EdgeWrapper1D(void*, const double,
  const Eigen::Matrix2d&, const Eigen::Matrix2d&, const Eigen::Matrix2d&,
