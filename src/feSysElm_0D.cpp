...
void feSysElm_0D_StiffSpring::computeBe(feBilinearForm *form)
{
  ...
  double vDot = form->_intSpaces[_idV]->interpolateFieldAtQuadNode(form->_solDot[_idV], 0);
  double x = form->_intSpaces[_idX]->interpolateFieldAtQuadNode(form->_sol[_idX], 0);
  double v = form->_intSpaces[_idV]->interpolateFieldAtQuadNode(form->_sol[_idV], 0);
  form->_Be[0] -= xDot - v;
...
void feSysElm_0D_Stiff2::computeBe(feBilinearForm *form)
{
  ...
  double x = form->_intSpaces[_idX]->interpolateFieldAtQuadNode(form->_sol[_idX], 0);
  double y = form->_intSpaces[_idY]->interpolateFieldAtQuadNode(form->_sol[_idY], 0);
  double z = form->_intSpaces[_idZ]->interpolateFieldAtQuadNode(form->_sol[_idZ], 0);
  form->_Be[0] -= xDot + x;
...
void feSysElm_0D_weakBC::computeBe(feBilinearForm *form)
{
  ...
  double lambda = form->_intSpaces[_idL]->interpolateFieldAtQuadNode(form->_sol[_idL], 0);
  double u = form->_intSpaces[_idU]->interpolateFieldAtQuadNode(form->_sol[_idU], 0);
  form->_Be[0] -= lambda;
  form->_Be[1] -= (u - gamma);
}
...
void feSysElm_0D_weakBC_edo2::computeBe(feBilinearForm *form)
{
  ...
  double v = form->_intSpaces[_idV]->interpolateFieldAtQuadNode(form->_sol[_idV], 0);
  double vDot = form->_intSpaces[_idV]->interpolateFieldAtQuadNode(form->_solDot[_idV], 0);
  double w = form->_intSpaces[_idW]->interpolateFieldAtQuadNode(form->_sol[_idW], 0);
  double wDot = form->_intSpaces[_idW]->interpolateFieldAtQuadNode(form->_solDot[_idW], 0);
  form->_Be[0] -= lambda;
  form->_Be[1] -= (u - v);
  form->_Be[2] -= (vDot - w);
