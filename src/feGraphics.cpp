...
void feBasicViewer::reshapeWindowBox(double scaleFactorX, double scaleFactorY, feMesh &mesh, feSolution &solution)
{
#if defined(HAVE_GLFW)
  getWindowBox();
  double xMin =  DBL_MAX;
...
void feBasicViewer::drawEulerNozzle(feMesh &mesh,
                                    feMetaNumber &numbering,
                                    feSolution &solution,
