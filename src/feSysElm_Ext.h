...
public:
  feSysElm_1D_weakBC_edo1(double par, feFunction *fct)
    : feSysElm(1, 3, WEAKBC_EDO1_1D, true), _fct(fct), _par(par){};
...
public:
  feSysElm_0D_Stiff2(double par, feFunction *fct)
    : feSysElm(0, 3, STIFF2_0D, true), _fct(fct), _par(par){};
  ~feSysElm_0D_Stiff2() {}
  void createElementarySystem(std::vector<feSpace *> &space);
  void computeAe(feBilinearForm *form);
  void computeBe(feBilinearForm *form);
...
public:
  feSysElm_0D_Stiff3(double par, feFunction *fct)
    : feSysElm(0, 3, STIFF3_0D, true), _fct(fct), _par(par){};
  ~feSysElm_0D_Stiff3() {}
  void createElementarySystem(std::vector<feSpace *> &space);
  void computeAe(feBilinearForm *form);
  void computeBe(feBilinearForm *form);
...
public:
  feSysElm_0D_weakBC(double par, feFunction *fct)
    : feSysElm(0, 2, WEAKBC_0D, true), _fct(fct), _par(par){};
  ~feSysElm_0D_weakBC() {}
  void createElementarySystem(std::vector<feSpace *> &space);
  void computeAe(feBilinearForm *form);
  void computeBe(feBilinearForm *form);
...
public:
  feSysElm_0D_weakBC_edo1(double par, feFunction *fct)
    : feSysElm(0, 3, WEAKBC_EDO1_0D, true), _fct(fct), _par(par){};
...
public:
  feSysElm_0D_weakBC_edo1_V2(double par, feFunction *fct)
    : feSysElm(0, 3, WEAKBC_EDO1_V2_0D, true), _fct(fct), _par(par){};
...
public:
  feSysElm_0D_weakBC_edo2(double par, feFunction *fct)
    : feSysElm(0, 4, WEAKBC_EDO2_0D, true), _fct(fct), _par(par){};
...
//       // Le 1/2 vient de la transformation de [-1,1] à [0,1], qui est ensuite envoyé dans
//       l'espace
//       // physique
