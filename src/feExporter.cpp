...
feExporterVTK::feExporterVTK(std::string vtkFile, feMesh *mesh, feSolution *sol,
                             feMetaNumber *metaNumber, const std::vector<feSpace *> &space)
  : feExporter(mesh, sol, metaNumber, space) {
  std::filebuf fb;
