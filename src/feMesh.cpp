    ...
    _nNodBoundary(1)
{
  ...
  feCncGeo *geoDom =
    new feCncGeo(nCncGeo, dimDomain, _nNodDomain, _nInteriorElm, 1, _domID, geometryType::LINE,
  ...
  feCncGeo *geoBndA = new feCncGeo(nCncGeo, dimBoundary, _nNodBoundary, _nElmPerBoundary, 0,
  ...
  feCncGeo *geoBndB = new feCncGeo(nCncGeo, dimBoundary, _nNodBoundary, _nElmPerBoundary, 0,
    ...
    _nNodDomain(1), _nNodBoundary(1)
{
  ...
  int nCncGeo = 0;
  feCncGeo *geoDom =
    new feCncGeo(nCncGeo, dimDomain, _nNodDomain, _nElmDomain, 0, _domID, geometryType::POINT,
                              ...
                              bool returnLocalElmTag, std::string targetConnectivity)
{
  ...
  void feMesh2DP1::transfer(
    feMesh2DP1 * otherMesh, feMetaNumber * myMN, feMetaNumber * otherMN,
    feSolutionContainer * solutionContainer, const std::vector<feSpace *> &mySpaces,
    const std::vector<feSpace *> &mySpacesEssBC, const std::vector<feSpace *> &otherSpaces)
  {
