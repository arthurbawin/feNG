    ...
    for(size_t i = 0; i < nodeTags.size(); i++) {
     ...
     if(_options.useAnalyticDerivatives) {
      ...
      #endif
      {
        ...
        _metrics[_nodeTag2sequentialTag[_nodeTags[i]]](0,0) = Q(0,0);
        _metrics[_nodeTag2sequentialTag[_nodeTags[i]]](0,1) = Q(0,1);
        _metrics[_nodeTag2sequentialTag[_nodeTags[i]]](1,0) = Q(1,0);
        _metrics[_nodeTag2sequentialTag[_nodeTags[i]]](1,1) = Q(1,1);
