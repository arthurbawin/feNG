...
feStatus createFiniteElementSpace(
  feSpace *&space, feMesh *mesh, int dim, elemType type, int deg, std::string fieldID,
  std::string cncGeoID, int dQuad, feFunction *fct,
  bool useGlobalShapeFunctions) // où est définit le P1 non conforme ? => non consistant ?
{
