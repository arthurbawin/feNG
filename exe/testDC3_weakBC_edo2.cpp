...
//   double x1 = x[0];
//   return -x1 * (x1 * x1 - 25.) * 6. * pow(t, 5.)  + c1 * 6. * x1 * pow(t, c2) ;
// }
...
//   double beta = (c2 == 0.) ? 0. : c2 * pow(t, c2 - 1.);
//   double x1 = x[0];
//   return x1 * (x1 * x1 - 25.) * 6. * pow(t, 5.) ;
// }

// tab 4.75 avec edo2 a la place d'edo1
double fSol(const double t, const std::vector<double> &x, const std::vector<double> par) {
  double x1 = x[0];
...
double fSolDotDot(const double t, const std::vector<double> &x, const std::vector<double> par) {
  double x1 = x[0];
  return 30. * x1 * x1 * x1 * (x1 * x1 - 25.) * pow(t, 4) + 30. * pow(x1, 5) * pow(t, 4);
}
