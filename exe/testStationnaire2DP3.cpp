...
int main(int argc, char** argv){
  ...
  for(int iter = 0; iter < nIter; ++iter){
    ...
    feBilinearForm *diffV = new feBilinearForm(spaceDiffusion2D_V, mesh, nQuad, new feSysElm_2D_Diffusion(kd, nullptr));
    feBilinearForm *sourceU = new feBilinearForm(spaceSource2D_U, mesh, nQuad, new feSysElm_2D_Source(1.0, funSource));
    feBilinearForm *sourceV = new feBilinearForm(spaceSource2D_V, mesh, nQuad, new feSysElm_2D_Source(1.0, funSource));
