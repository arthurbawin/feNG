...
int main(int argc, char **argv) {
  ...
  for(int iter = 0; iter < nIter; ++iter) {
    ...
    std::string meshName = "../../data/Circle/circleP2_" + std::to_string(iter + 1) + ".msh";
    // Maillage
    ...
    feBilinearForm *weakBC_U_bord = new feBilinearForm(spaceWeak_bord, mesh, degQuad,
    ...
    std::vector<feNorm *> norms = {normBDF2,        normDC3,        int_Lambda_BDF2,
                                   int_Lambda_BDF2, int_Lambda_DC3, int_Lambda_DC3};
