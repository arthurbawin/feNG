...
int main(int argc, char **argv) {
  ...
  feBilinearForm *bDiff_U_M1D =
    new feBilinearForm(spaceDiffusion1D_U_M1D, &mesh, degQuadrature, diffusion1D);
  feBilinearForm *bDiff_V_M1D =
    new feBilinearForm(spaceDiffusion1D_V_M1D, &mesh, degQuadrature, diffusion1D);
  // feBilinearForm *bDiff_U_M1D = new feBilinearForm({&U_M1D}, &mesh, nQuadraturePoints,
  // diffusion1D);
