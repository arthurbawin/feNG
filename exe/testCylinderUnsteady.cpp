...
int main(int argc, char** argv){
  ...
  for(int iter = 0; iter < nIter; ++iter){
    ...
    feBilinearForm *NS2D = new feBilinearForm(spacesNS2D, mesh, dQuad, new feSysElm_2D_NavierStokes(stokesParam, nullptr));
    ...
    printf("  nDOFs = %10d (%10d inc. + %10d ess.)                                      \n", 
      metaNumber->getNbDOFs(),
      metaNumber->getNbUnknowns(),
    ...
    std::vector<feSpace*> otherSpaces = {U_bas2, U_haut2, U_gauche2, U_cylindre2, U_surface2,
                                         V_bas2, V_haut2, V_gauche2, V_cylindre2, V_surface2, 
                                         P_surface2};

    std::vector<feSpace*> otherSpacesEss = {U_gauche2, U_cylindre2,
                                            V_bas2, V_haut2, V_gauche2, V_cylindre2};
