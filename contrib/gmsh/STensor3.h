...
public:
  ...
  inline void set_m22(double x) { _val[2] = x; }
  inline void set_m31(double x) { _val[3] = x; }
  inline void set_m32(double x) { _val[4] = x; }
  inline void set_m33(double x) { _val[5] = x; }
...
public:
  ...
  STensor3 invert() const
  {
    ...
    if(det == 0.)
      ...
      printf("det=0 in STensor inversion\n");
    else
      udet = 1. / det;
    ithis(0, 0) =
